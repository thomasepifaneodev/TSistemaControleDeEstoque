inherited uFrmMovimentacoesContasAReceber: TuFrmMovimentacoesContasAReceber
  ...
  inherited dxPanelCenter: TdxPanel
    Width = 1000
    Height = 497
    object cxDBTreeListContasAReceber: TcxDBTreeList
      AlignWithMargins = True
      Left = 10
      Top = 10
      Width = 980
      ...
      TabOrder = 0
      OnDblClick = cxDBTreeListContasAReceberDblClick
      ExplicitWidth = 976
      ExplicitHeight = 480
      object cxDBTreeListContasAReceberIdConta: TcxDBTreeListColumn
      ...
      object cxDBTreeListContasAReceberFornecedor: TcxDBTreeListColumn
      ...
      object cxDBTreeListContasAReceberSituacao: TcxDBTreeListColumn
      ...
      object cxDBTreeListContasAReceberValor: TcxDBTreeListColumn
        Caption.Text = 'Valor'
